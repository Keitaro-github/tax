...
class Server:
    ...
    #         cursor.execute("INSERT INTO tms_users (username, password) VALUES (?, ?)", (username, hashed_password))
    #         conn.commit()
    #         print(f"Password for user {username} saved successfully.")
    #     except Exception as e:
...
if __name__ == '__main__':
    ...
    # sign_in_services.save_user_password("Ivan", "123456")
    # sign_in_services.save_user_password("Keitaro", "123123")
    # sign_in_services.save_user_password("Guest", "987654")
